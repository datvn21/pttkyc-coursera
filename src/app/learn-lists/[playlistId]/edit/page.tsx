...
import StoredLearnListEditor from "@/components/playlists/StoredLearnListEditor";

export default async function EditLearnListPage({
  params,
}: {
  ...
  return (
    <div className="min-h-screen bg-coursera-light font-sans text-gray-900">
      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        ...
        <StoredLearnListEditor playlistId={playlistId} />
      </main>
      <Footer />
    </div>
  );
