    ...
    <div className="h-screen w-full bg-[#f5f5f5] text-gray-900 flex flex-col font-sans overflow-hidden">
      ...
      <header className="h-16 px-6 border-b border-gray-200 flex items-center justify-between bg-white z-10 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div className="ml-4 px-2.5 py-1 rounded-md bg-red-50 text-red-600 border border-red-200 flex items-center gap-2 text-xs font-bold uppercase tracking-wider">
            <span className="w-2 h-2 rounded-full bg-red-600 animate-pulse"></span>
            Live
          </div>
          <div className="ml-2 px-2.5 py-1 rounded-md bg-gray-100 border border-gray-200 flex items-center gap-1.5 text-xs text-gray-700 font-medium">
            <Users size={14} />
            1,204
          </div>
        </div>
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col p-4 gap-4">
          ...
          <div className="flex-1 bg-black rounded-2xl border border-gray-200 overflow-hidden relative shadow-md group flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-black flex flex-col items-center justify-center text-gray-500">
